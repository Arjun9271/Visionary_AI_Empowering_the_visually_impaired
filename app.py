...
#     st.title("Visionary AI:Empowering the Visually Impaired")
    
#     st.sidebar.header("About This Tool")
#     st.sidebar.info("""
#     This application provides multiple accessibility-focused image analysis techniques:
    
#     - **Scene Understanding**: Detailed visual scene descriptions
#     - **Text to Speech**: OCR and text extraction
#     - **Object Detection**: Safety and navigation insights
#     - **Task Guidance**: Context-specific instructions
#     """)
...
#         on_change=reset_states  # Reset states when new file is uploaded
#     )
...
#                 cleanup_temp_files()  # Clean up before new analysis
...
#                 # Clean up previous audio before generating new one
#                 cleanup_temp_files()
